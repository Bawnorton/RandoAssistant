...
public class RenderingHelper {
    ...
    public static void renderIdentifier(Identifier id, MatrixStack matrices, int x, int y) {
        switch (IdentifierType.fromId(id)) {
            case ENTITY -> {
            ...
            case OTHER -> client.getItemRenderer().renderGuiItemIcon(matrices, new ItemStack(Items.CHEST), x, y);
        }
    }
